...
TYPEDESCRIPTION CScientistGiant::m_SaveData[] =
{
	DEFINE_FIELD(CScientistGiant, m_painTime, FIELD_TIME),
	DEFINE_FIELD(CScientistGiant, m_healTime, FIELD_TIME),
	DEFINE_FIELD(CScientistGiant, m_fearTime, FIELD_TIME),
};

IMPLEMENT_SAVERESTORE(CScientistGiant, CScientist);
...
void CScientistGiant::Spawn(void)
{
	...
	SET_MODEL(ENT(pev), "models/scientist_gigante.mdl");
	UTIL_SetSize(pev, VEC_HUMAN_HULL_MIN, VEC_HUMAN_HULL_MAX);
...
TYPEDESCRIPTION CScientistParaguai::m_SaveData[] =
{
	DEFINE_FIELD(CScientistParaguai, m_painTime, FIELD_TIME),
	DEFINE_FIELD(CScientistParaguai, m_healTime, FIELD_TIME),
	DEFINE_FIELD(CScientistParaguai, m_fearTime, FIELD_TIME),
};

IMPLEMENT_SAVERESTORE(CScientistParaguai, CScientist);

LINK_ENTITY_TO_CLASS(monster_scientist_falsificado, CScientistParaguai);

//=========================================================
// Spawn
//=========================================================
void CScientistParaguai::Spawn(void)
{
	Precache();

	SET_MODEL(ENT(pev), "models/scientist_falsificado.mdl");
	UTIL_SetSize(pev, VEC_HUMAN_HULL_MIN, VEC_HUMAN_HULL_MAX);
...
// Precache - precaches all resources this monster needs
//=========================================================
void CScientistParaguai::Precache(void)
{
	PRECACHE_MODEL("models/scientist_falsificado.mdl");
	PRECACHE_SOUND("scientist/sci_pain1.wav");
	PRECACHE_SOUND("scientist/sci_pain2.wav");
	PRECACHE_SOUND("scientist/sci_pain3.wav");
	PRECACHE_SOUND("scientist/sci_pain4.wav");
